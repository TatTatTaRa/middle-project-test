...
const PARTNER_NAV = [
  ...
  { icon: '💬', label: '일정 협의 안내', href: 'partner-schedule-memo.html', id: 'schedulememo' },
  { section: '객실·판매' },
  ...
  { icon: '↩️', label: '환불 정산', href: 'partner-refunds.html', id: 'refunds', badge: '3' },
  { section: '기타' },
...
const ADMIN_NAV = [
  ...
  { icon: '⏳', label: '승인 대기', href: 'admin-partners-pending.html', id: 'pending', badge: '5' },
  { section: '플랫폼' },
