...
const ADMIN_NAV = [
  ...
  { section: '파트너 관리' },
  { icon: '✅', label: '파트너 심사', href: 'admin-partners-pending.html', id: 'partners-pending' },
  { icon: '🏨', label: '파트너 관리', href: 'admin-partners.html', id: 'partners' },
  { icon: '🔍', label: '숙소 심사 관리', href: 'admin-accommodations-review.html', id: 'accommodations-review' },
  { icon: '🏠', label: '숙소 목록 관리', href: 'admin-accommodations-list.html', id: 'accommodations-list' },
  ...
  { section: '정산 관리' },
  { icon: '💳', label: '통합 결제 내역', href: 'admin-payments.html', id: 'payments' },
